...
// 1_1 1_2 2_1 2_2
@Deprecated
abstract class GenericGlassCrackedPieceActor_GLASS_2 extends TableActor implements Pool.Poolable {
  public static final float DEFAULT_FADE_OUT_TIME = 2f;
  public static final float DEFAULT_DELAY_TIME = 0.5f;
  static final int MAX_CRACK_POOL_INSTANCE_COUNT = 200;
  public static final Pool<GenericGlassCrackedPieceActor1>
      GENERIC_GLASS_CRACKED_PIECE_ACTOR_1_POOL =
          Pools.get(GenericGlassCrackedPieceActor1.class, MAX_CRACK_POOL_INSTANCE_COUNT);
  public static final Pool<GenericGlassCrackedPieceActor2_1>
      GENERIC_GLASS_CRACKED_PIECE_ACTOR_2_1_POOL =
          Pools.get(GenericGlassCrackedPieceActor2_1.class, MAX_CRACK_POOL_INSTANCE_COUNT);
  public static final Pool<GenericGlassCrackedPieceActor1_1>
      GENERIC_GLASS_CRACKED_PIECE_ACTOR_1_1_POOL =
          Pools.get(GenericGlassCrackedPieceActor1_1.class, MAX_CRACK_POOL_INSTANCE_COUNT);
  public static final Pool<GenericGlassCrackedPieceActor1_2>
      GENERIC_GLASS_CRACKED_PIECE_ACTOR_1_2_POOL =
          Pools.get(GenericGlassCrackedPieceActor1_2.class, MAX_CRACK_POOL_INSTANCE_COUNT);
  public static final Pool<GenericGlassCrackedPieceActor2>
      GENERIC_GLASS_CRACKED_PIECE_ACTOR_2_POOL =
          Pools.get(GenericGlassCrackedPieceActor2.class, MAX_CRACK_POOL_INSTANCE_COUNT);
  public static final Pool<GenericGlassCrackedPieceActor2_2>
      GENERIC_GLASS_CRACKED_PIECE_ACTOR_2_2_POOL =
          Pools.get(GenericGlassCrackedPieceActor2_2.class, MAX_CRACK_POOL_INSTANCE_COUNT);
  public static final Pool<RandomPieceActor> RANDOM_PIECE_ACTOR_POOL =
      Pools.get(RandomPieceActor.class, MAX_CRACK_POOL_INSTANCE_COUNT);
  static final float CLIMB_DURATION = 0.4f;

  static int crackTurn = 0;

  private GenericGlassCrackedPieceActor_GLASS_2() {}
  ...
  public static void createAllPiecesWithSplit(
    ...
    Preconditions.checkArgument(data == GenericGlassBallCrackedPieceActorData.GLASS_2);

    switch (crackTurn) {
      case 0: // 1 2
        {
          GenericGlassCrackedPieceActor1 actor1 = GENERIC_GLASS_CRACKED_PIECE_ACTOR_1_POOL.obtain();
          actor1.init(sizeInMeter, sizeInMeter, x, y, assets, data, fadeOutTime, delayTime);
          GenericGlassCrackedPieceActor2 actor2 = GENERIC_GLASS_CRACKED_PIECE_ACTOR_2_POOL.obtain();
      ...
      case 1: // 1 	2_1 2_2
        {
          GenericGlassCrackedPieceActor1 actor1 = GENERIC_GLASS_CRACKED_PIECE_ACTOR_1_POOL.obtain();
          actor1.init(sizeInMeter, sizeInMeter, x, y, assets, data, fadeOutTime, delayTime);
          GenericGlassCrackedPieceActor2_1 actor2_1 =
          ...
          GenericGlassCrackedPieceActor2_2 actor2_2 =
      ...
      case 2: // 1_1 1_2 	2
        {
          GenericGlassCrackedPieceActor1_1 actor1_1 =
          ...
          GenericGlassCrackedPieceActor1_2 actor1_2 =
    ...
    if (data.getCrack1Atlas() != null) {
      for (int i = MathUtils.random(5, 11); i > 0; i--) {
        ...
        RandomPieceActor piece = RANDOM_PIECE_ACTOR_POOL.obtain();
        piece.init(
  ...
  private static class GenericGlassCrackedPieceActor1
      extends GenericGlassCrackedPieceActor_GLASS_2 {
  ...
  private static class RandomPieceActor extends GenericGlassCrackedPieceActor_GLASS_2 {
