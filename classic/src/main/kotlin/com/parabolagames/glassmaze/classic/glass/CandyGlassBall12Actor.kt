...
internal class CandyGlassBall12Actor : GenericCandyGlassBallActor(true) {
    ...
    override fun initCandyEffect(assets: Assets) = candyEffect.load(Gdx.files.internal("effects/candy12.p"), assets.getTextureAtlas(Assets.FIRE_ATLAS))
    ...
    companion object {
        ...
        fun disposeObjectPools() {
            Pools.get(CandyGlassBall12Actor::class.java).clear()
            Gdx.app.debug(TAG, "pool disposed")
        }

        const val TAG = "com.parabolagames.glassmaze.CandyGlassBall12Actor"
