...
/** <img src="{@docRoot}/../../android/assets/candy4/candy.png"></img>  */
internal class CandyGlassBall4Actor : GenericCandyGlassBallActor(true) {
    ...
    override fun setParent(parent: Group?) {
        ...
        if (parent == null) {
            Pools.get(CandyGlassBall4Actor::class.java).free(this)
    ...
    companion object {
        ...
        fun disposeObjectPools() {
            Pools.get(CandyGlassBall4Actor::class.java).clear()
            Gdx.app.debug(TAG, "pool disposed")
        }

        const val TAG = "com.parabolagames.glassmaze.CandyGlassBall4Actor"

        private val DATA = GenericCandyGlassBallActorData(Assets.CANDY4_ATLAS, { MathUtils.random(0.01f, 0.09f) }, true)
    }
}