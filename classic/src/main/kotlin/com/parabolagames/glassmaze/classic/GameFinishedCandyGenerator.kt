...
@ForGame
internal class GameFinishedCandyGenerator
@Inject constructor(
    ...
    fun addGenericCandyGlassBallActorData(data: GenericCandyGlassBallActorData) = gainedCandyDataList.add(data)
