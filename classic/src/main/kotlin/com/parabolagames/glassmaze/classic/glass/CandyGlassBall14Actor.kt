...
internal class CandyGlassBall14Actor : GenericCandyGlassBallActor(true) {
    ...
    override fun initCandyEffect(assets: Assets) = candyEffect.load(Gdx.files.internal("effects/candy14.p"), assets.getTextureAtlas(Assets.FIRE_ATLAS))
    ...
    companion object {
        ...
        fun disposeObjectPools() {
            Pools.get(CandyGlassBall14Actor::class.java).clear()
            Gdx.app.debug(TAG, "pool disposed")
        }

        const val TAG = "com.parabolagames.glassmaze.CandyGlassBall14Actor"
